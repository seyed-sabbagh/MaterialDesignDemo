...
import com.Seyed.materialdesign.adapter.FragmentAdapter;
import com.Seyed.materialdesign.fragment.CardsFragment;
import com.Seyed.materialdesign.fragment.DialogsFragment;
import com.Seyed.materialdesign.fragment.WidgetsFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_menu_main_about) {
